...
return [
    ...
    */
    ...
    'disks' => [
        ...
        'pfizer_ftp_out_folders' => [
            'driver' => 'sftp',
            'host' => env('PFIZER_FTP_HOST'),
            'username' => env('PFIZER_FTP_USER'),
            //'password' =>  env('PFIZER_FTP_PASS'),
            'privateKey' => env('SFTP_PRIVATE_KEY'),
            //'passphrase' => env('PFIZER_FTP_PASS'),
            'port' => 2222,
            'root' => env('SFTP_ROOT', '/'),
            'timeout' => 30,
            'directoryPerm' => 0755
