...
class MiscController extends Controller
{
    ...
    public function productUpdate(Request $request)
    {
        ...
        $differences = PfizerHelper::getModifiedProductFields($request->productData, $product);
    ...
    public function pharmacyUpdate(Request $request)
    {
        ...
        if ($request->new_farm == "1"){
            ...
            $differences = PfizerHelper::getModifiedFields($request->pharmacyData, $existingPharmacy);
            ...
            if (count($differences)  && ! $only_iban ) {
                ...
                $existingPharmacy->pharmacy_sent_to_pfizer = 0;
